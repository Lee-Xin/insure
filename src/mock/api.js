...
export const apiSupplierListSearchPageInation = (p) => getUrl('/supplier_list_search_pageInation', p);
export const apiSupplierAdd = p => post('/supplier_add', p);
export const supplierGetAll = p => get('/SupplierService/GetAll', p);
export const supplierGetCooperationStatus = p => get('/SupplierService/GetCooperationStatus');
export const supplierGetCooperationType = p => get('/SupplierService/GetCooperationType');
...
export const apiQuarterlyPromotionSearch = p => get('/quarterly_promotion_search', p);

export const apiDownstreamFoldingSearch = p => get('/downstream_folding_search', p);
export const apiDownstreamFoldingAdd = p => get('/downstream_folding_add',p);
export const apiInstitutionalExpensesSearch = p => get('/institutional_expenses_search', p);
export const apiInstitutionalExpensesAdd =p => get('/institutional_expensesAdd', p);
