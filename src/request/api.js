...
import {post,get,getUrl,posts} from './http'
...
//-----------------供应商管理-------------
//---供应商列表
export const apiSupperListSearchType = () => get('/SupplierService/GetCooperationType');
export const apiSupplierListSearchStatus = () => get('/SupplierService/GetCooperationStatus');
export const apiSupplierListSearchPageInation = p => getUrl('/SupplierService/GetAll', p);
export const apiSupplierListGetById = p => getUrl('/SupplierService/GetById', p);
...
//---继续率搜索参数
export const apiContinuationRateBounsParam = () => get('/continuation_rate_bouns_param');
//---继续率查询
export const apiContinuationRateBounsSearch = p => post('/continuation_rate_bouns_search', p);
//---继续率分页
export const apiContinuationRateBounsPageInation = p => getUrl('/continuation_rate_bouns_pageInation', p);
//---继续率保存/提交
export const apiContinuationRateBounsAdd = p => post('/continuation_rate_bouns_add', p);
//---新增奖励search选项
...
//---新增分页
export const apiNewIncentivesPageInation = p => getUrl('/new_incentives_pageInation', p);
//---新增奖励提交保存
...
export const apiRenewalServicePageInation = p => getUrl('/renewal_service_pageInation', p);
export const apiRenewalServiceAdd = p => post('/renewal_service_add', p);
//---季度推动奖
export const apiQuarterlyPromotionAwardParam = () => get('/quarterly_promotion_award_param');
export const apiQuarterlyPromotionAwardSearch = p => post('/quarterly_promotion_award_search', p);
export const apiQuarterlyPromotionAwardPagrInation = p =>getUrl('/quarterly_promotion_award_pagrInation',p);
//-------------------下游策略---------------------
//---下游折标
export const apiDownstreamFoldingParam = () => get('/downstream_folding_param');
export const apiDownstreamFoldingSearch = p => post('/downstream_folding_search', p);
export const apiDownstreamFoldingPageInation = p => getUrl('/downstream_folding_pageInation', p);
//---机构费用
export const apiInstitutionalExpensesParam = () => get('/institutional_expenses_param');
export const apiInstitutionalExpensesSearch = p => post('/institutional_expenses_search', p);
export const apiInstitutionalExpensesPageInation = p => getUrl('/institutional_expenses_pageIntaion', p);
export const apiInstitutionalExpensesSave = p => post('/institutional_expenses_save', p);
//---查询机构
export const apiInstitutionsQuery = p => post('/institutions_query', p);
export const apiInstitutionsDelete = p => post('/institutions_delete', p);
//---销售费用
export const apiSalesExpensesParam = () => get('/sales_expenses_param');
export const apiSalesExpensesSearch = p => post('/sales_expenses_search', p);
...
export const apiWorkerManagementSearch = p => get('/worker_management_search', p);
...
export const apiBasicLawAdministration = p => get('/basicLaw_administration', p);
export const apiSalarySettlementSearch = p => get('/salary_settlement_search', p);
export const apiSalarySettlement = p => get('/salary_settlement', p);
export const apiAttendanceManagementSearch = p => get('/attendance_management_search', p);
export const apiDeductionSearch = p => get('/deduction_search', p);

export const apiCompanyRetentionRateSearch = p => get('/company_retention_rate_search',p);

export const apiTargetConfigurationSearch = p => get('/target_configuration_search', p);
...
// app 首页管理-热销产品-删除
export const APPHomepageModuleDelete = (obj) =>posts('APPHomepageModuleDelete',obj)
// app 首页管理-轮播
export const APPHomepageModuleBanner = (obj) =>get('APPHomepageModuleBanner', obj)
