        ...
        <el-tab-pane label="月度">
          <div class="ManpowerReportSearch_moth">
            <el-form ref="monthForm" :model="monthForm" class="search_form">
              ...
              <el-form-item>
                <div class="cell_before">团队类型</div>

                <el-select v-model="monthForm.teamType" placeholder="请选择团队类型" clearable filterable>
                  <el-option
          ...
          <div class="ManpowerReportSearch_moth">
            <el-form ref="yearForm" :model="yearForm" class="search_form">
              ...
              <el-form-item>
                ...
                <el-select v-model="yearForm.teamType" placeholder="请选择团队类型" clearable filterable>
                  <el-option
                    v-for="item in teamTypeList"
                    :key="item.id"
                    :label="item.name"
...
export default {
  ...
  methods: {
    ...
    //  搜索数据
    getList(form) {
      getDirectTeamReport(form).then(res => {
        if (res.success) {
          if (form.type == 1) {
