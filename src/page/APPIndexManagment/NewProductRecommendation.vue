        ...
        <div class="main-box">
          ...
          <div class="data-operating">
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
              <el-tab-pane label="推荐险种管理" name="one">
                <div style="text-align: right; margin: 16px 0">
                  <el-button type="warning" @click="hideMsak()" icon="el-icon-plus">新增推荐险种</el-button>
                </div>
                <el-table
                  :data="tableData"
...
export default {
  ...
  data() {
    return {
      ...
      pagesTotal: 0,
      tableData: [
        {id: 1, name: '百年康盛保终身重大疾病保险', description: ['承保年龄0-60周岁', '交费期间,3年交、5年交、10年交、15年交、20年、30年','保险期间终身', '最低保额10万'], tags: ['重疾险','多次赔'], link: "http://**.cn", sort: 1,createTime: '2019-11-14'},
        {id: 2, name: '百年康盛保终身重大疾病保险', description: ['承保年龄0-60周岁', '交费期间,3年交、5年交、10年交、15年交、20年、30年','保险期间终身', '最低保额10万'], tags: [], link: "http://**.cn", sort: 2,createTime: '2019-11-14'},
        {id: 3, name: '百年康盛保终身重大疾病保险', description: ['承保年龄0-60周岁', '交费期间,3年交、5年交、10年交、15年交、20年、30年','保险期间终身', '最低保额10万'], tags: ['重疾险'], link: "http://**.cn", sort: 3,createTime: '2019-11-14'},
        {id: 3, name: '百年康盛保终身重大疾病保险', description: ['承保年龄0-60周岁', '交费期间,3年交、5年交、10年交、15年交、20年、30年','保险期间终身', '最低保额10万'], tags: ['重疾险','多次赔'], link: "http://**.cn", sort: 4,createTime: '2019-11-14'}
      ],
      hotTableData: [],
      bannerTableData: [],
      // 导航分类唯一标识
