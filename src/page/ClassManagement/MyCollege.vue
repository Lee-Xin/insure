  ...
  <div>
    ...
    <div class="content_box" v-show="mainshow">
      ...
      <el-table
        ...
        style="width: 100%;padding: 0 10%; border: 1px solid #aaa; margin-top: 30px; margin-bottom: 50px;">
        <el-table-column
          type="index">
        </el-table-column>
        <el-table-column
    ...
    <el-form v-if="updshow" label-width="100px" class="demo-dynamic">
      ...
      <el-form-item label="封面">
        <el-upload
          ...
          :on-success="handleAvatarSuccess7"
          :before-upload="beforeAvatarUpload">
          <img v-if="updata.pic" :src="updata.pic" class="avatar">
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
        </el-upload>
      </el-form-item>
      <el-form-item label="详细信息">
...
<script>
    ...
    import {GetLpclass, zhishilist, addzhishi, delzhishi, updzhishi, qxfabuzhishi, fabuzhishi} from "@/request/api"
    ...
    export default {
        ...
        methods: {
            ...
            oks1: function () {
                ...
                updzhishi(that.updata).then(res => {
            ...
            fabu() {
                ...
                fabuzhishi({id: this.currentRow}).then(res => {
            ...
            quxiaofabu() {
                ...
                qxfabuzhishi({id: this.currentRow}).then(res => {
                    that.$message(res.Msg);
                    that.accountdata = res.Data
                })
            },
            del: function () {
                ...
                delzhishi({id: this.currentRow}).then(res => {
                    that.$message(res.Msg);
                    that.accountdata = res.Data
                })
            },
