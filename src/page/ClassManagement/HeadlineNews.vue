    ...
    <div class="content_box" v-show="mainshow">
      ...
      >
        <div>
          ...
          <el-button @click="upd()" type="primary">编辑</el-button>
          <el-button @click="fabu()" type="primary">发布</el-button>
          <el-button @click="quxiaofabu()" type="primary">取消发布</el-button>
        </div>
      </page-ination>
    </div>
    <!--添加-->
...
import { getAuthorList, getHeadlineNewsList } from "@/mock/api";
export default {
  name: "HeadlineNews",
  data() {
    return {
